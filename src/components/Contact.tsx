            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 rounded-xl text-sm sm:text-base transition-all duration-300 focus:outline-none focus:ring-1"
                  style={{
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full px-4 py-3 rounded-xl resize-none text-sm sm:text-base transition-all duration-300 focus:outline-none focus:ring-1"
                  style={{
                    background: "var(--bg-input)",
                    border: "1px solid var(--input-border)",
                    color: "var(--text-primary)",
          ...
          >
            <div className="glass rounded-2xl p-5 sm:p-6">
              ...
              <div className="space-y-4">
                ...
                >
                  <div className="p-2.5 rounded-lg transition-colors" style={{ background: "var(--badge-bg)", color: "var(--text-accent)" }}>
                    <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                    </svg>
                  </div>
                  <span className="text-sm group-hover:text-brand-light transition-colors">uf031186@gmail.com</span>
                </a>
                <a
                ...
                >
                  ...
                  <span className="text-sm group-hover:text-brand-light transition-colors">WhatsApp</span>
                </a>
                <a
                ...
                >
                  ...
                  <span className="text-sm group-hover:text-brand-light transition-colors">GitHub</span>
                </a>
              </div>
            </div>
